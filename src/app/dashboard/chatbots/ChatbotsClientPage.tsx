...
export default function ChatbotsClientPage({ initialChatbots, fetchError }: { initialChatbots: Chatbot[], fetchError: string | null }) {
  ...
  useEffect(() => {
    async function loadChatbots() {
      ...
      if (demoUserStr) {
        ...
        if (fetchError) {
          console.error("Fetch error from server:", fetchError);
        }
      }
